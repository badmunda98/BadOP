'''
Author    : Pbxteam 
Github    : https://github.com/badmunda98
Repository: https://github.com/badmunda98/BadOP
'''
from PIL import Image, ImageFont, ImageDraw
import os
font=ImageFont.truetype(os.path.dirname(__file__)+"/BadOP.otf", 230)
def BadOP(teks):
    (draw:=ImageDraw.Draw((img:=Image.new("RGB", ((length:=font.getsize(0))[0]+100, length[1]), color=(0, 0, 0))))).text((int((img.width/2)-(draw.textsize(teks, font)[0]/2)), int(-25)), teks, fill=(255, 148, 224), font=font)
